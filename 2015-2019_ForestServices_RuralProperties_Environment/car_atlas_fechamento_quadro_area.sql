...
sum(quadro_area.num_area_app_reservatorio) as a_reservatorio ,
sum(quadro_area.num_area_app_rio_ate_10) as a_apprio10 ,
sum(quadro_area.num_area_app_rio_10_a_50) as a_apprio10a50,
sum(num_area_app_escadinha_rio_50_a_200) as a_appesc_rio50a200,
sum(num_area_app_escadinha_rio_200_a_600) as a_appesc_rio200a600 ,
sum(num_area_app_escadinha_rio_acima_600)  as a_appesc_rioacima600,
...
WHERE
imovel.ind_status_imovel in ('AT','PE') AND imovel.flg_ativo = TRUE and
